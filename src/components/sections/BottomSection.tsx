    ...
    <section className="py-24 border-t border-white/5">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            <div>
              <p className="text-xs font-semibold tracking-widest uppercase text-[#7b68ee] mb-3">
                {lang === "fr" ? "Travaillons ensemble" : "Let's work together"}
              </p>
              <h3 className="text-2xl font-extrabold text-white mb-3 leading-tight">
                {lang === "fr" ? "Vous avez un projet en tête ?" : "Got a project in mind?"}
              </h3>
              <p className="text-slate-500 text-sm leading-relaxed">
                {lang === "fr"
                  ? "Transformons vos idées en produits digitaux qui font la différence."
                  : "Let's turn your ideas into digital products that make a difference."}
              </p>
            </div>
            <motion.button
            ...
            >
              {lang === "fr" ? "Démarrer" : "Get started"} <FiArrowRight className="w-4 h-4" />
            </motion.button>
          </motion.div>
